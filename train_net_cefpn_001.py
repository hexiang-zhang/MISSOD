...
TRAIN_LABEL_JSON =  os.path.join(ANN_ROOT, 'instances_train2014_label_0.01.json')
TRAIN_UNLABEL_JSON = os.path.join(ANN_ROOT, 'instances_train2014_unlabel_0.01.json')
